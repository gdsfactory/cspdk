...
filepath = PATH.repo / "docs" / "cells_si220.md"
...
with open(filepath, "w+") as f:
    f.write("# Cells Si SOI 220nm C-band and O-band\n\n")
    ...
    for name in sorted(cells.keys()):
        ...
        f.write(f"## {name}\n\n")
        f.write(f"::: cspdk.si220.cells.{name}\n   :noindex:\n\n")
        if name not in skip_plot:
            ...
            f.write("```python\n")
            f.write("from cspdk.si220 import cells, PDK\n\n")
