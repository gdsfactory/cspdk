...
def straight_heater_metal(
    ...
    cross_section_waveguide_heater: CrossSectionSpec = "strip_heater",
    cross_section_heater_undercut: CrossSectionSpec = "strip_heater",
...
die_rib = partial(die, cross_section="rib")
