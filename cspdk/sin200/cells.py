"""This module contains the building blocks for the SiN200 technology."""
...
from cspdk.sin200._schematic import (
...
def mzi(
    ...
    splitter="mmi1x2_n780",
    combiner="mmi2x2_n780",
    cross_section: CrossSectionSpec = "xs_n780",
) -> Component:
...
mzi_n638 = partial(
    ...
    splitter="mmi1x2_n638",
    combiner="mmi2x2_n638",
    cross_section="xs_n638",
)
...
mzi_n520 = partial(
    ...
    splitter="mmi1x2_n520",
    combiner="mmi2x2_n520",
    cross_section="xs_n520",
)
...
die_n780 = partial(die, cross_section="xs_n780")
die_n638 = partial(die, cross_section="xs_n638")
die_n520 = partial(die, cross_section="xs_n520")
